...
def evaluate_models_on_training(x, y, models):
    ...
    for model in models:
        ...
        est_y_vals = a * xVals + b
        r_square_val = round(r_squared(y, est_y_vals), 5)
        pylab.plot(x, est_y_vals, 'r--',
                    label='Model fit, r**2 = '+str(r_square_val))
        pylab.title('Average temperature from 1961 to 2015')
